                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: ['All', 'Neha Mehta', 'Rohan Patel', 'Jiya Suthar'].map((manager) => DropdownMenuItem(value: manager, child: Text(manager, style: const TextStyle(fontFamily: 'Inter')))).toList(),
