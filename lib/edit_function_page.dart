...
class _EditFunctionPageState extends State<EditFunctionPage> {
  ...
  void initState() {
    super.initState();
    _functionNameController = TextEditingController(text: widget.functionName);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Function', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Inter')),
      ),
      body: Form(
        key: _formKey,
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: const Text('Update Function', style: TextStyle(color: Colors.white, fontFamily: 'Inter')),
                  ),
                ],
              ),
            ],
