    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              _buildStatCard(Icons.people, '0', 'Guest Invited',
                  const Color(0xFF520350), width),
              const SizedBox(width: 12),
              _buildStatCard(
                  Icons.check, '0', 'Invitation Accepted', Colors.green, width),
            ],
          ),
          ...
          Row(
            children: [
              _buildStatCard(
                  Icons.cancel, '0', 'Invitation Declined', Colors.red, width),
              const SizedBox(width: 12),
              _buildStatCard(Icons.person, '0', 'Confirmation Pending',
                  Colors.orange, width),
            ],
          ),
          const SizedBox(height: 16),
                ...
                if (request.notes.isNotEmpty) ...[
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.note,
                            size: width * 0.04, color: const Color(0xFF520350)),
                        SizedBox(width: width * 0.02),
                        Expanded(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: const BorderSide(
                            color: Color(0xFF520350), width: 2),
                      ),
                    ),
                  ),
                ],
  ...
  void _cancelRequest(ServiceRequest request) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title:
            const Text('Cancel Request', style: TextStyle(fontFamily: 'Inter')),
        content: const Text(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('Yes, Cancel',
                style:
                    TextStyle(color: Color(0xFF520350), fontFamily: 'Inter')),
          ),
        ],
      ),
    );
