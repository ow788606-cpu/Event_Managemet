...
class _GuestAccommodationPageState extends State<GuestAccommodationPage> {
  ...
  Future<void> _loadAccommodationData() async {
    try {
      final data =
          await DatabaseService.getEventAccommodation(eventId: widget.eventId);
      setState(() {
  ...
  Widget build(BuildContext context) {
    // if (isLoading) {
    //   return const Center(
    //       child: CircularProgressIndicator(color: Color(0xFF520350)));
    // }
    ...
    // );
    return const Center(
      child: Text('Coming Soon', style: TextStyle(fontSize: 16, fontFamily: 'Inter')),
    );
  }
  ...
  //         Expanded(
  //             flex: 1,
  //             child: Text('Day ${item['id']}',
  //                 style: const TextStyle(fontSize: 12, fontFamily: 'Inter'))),
  //         Expanded(
  //             flex: 2,
  //             child: Text(item['day_title'] ?? '',
  //                 style: const TextStyle(fontSize: 12, fontFamily: 'Inter'))),
  //         Expanded(
  //             flex: 2,
  //             child: Text(item['event_date'] ?? '',
  //                 style: const TextStyle(fontSize: 12, fontFamily: 'Inter'))),
  //         Expanded(
  //             flex: 1,
  //             child: Text('${item['guest_count'] ?? 0}',
  //                 style: const TextStyle(fontSize: 12, fontFamily: 'Inter'),
  //                 textAlign: TextAlign.center)),
  //         Expanded(
  //             flex: 1,
  //             child: Text('${item['rooms_required'] ?? 0}',
  //                 style: const TextStyle(fontSize: 12, fontFamily: 'Inter'),
  //                 textAlign: TextAlign.center)),
  //       ],
  //     ),
