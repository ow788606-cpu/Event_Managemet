...
class _EditTagPageState extends State<EditTagPage> {
  ...
  void initState() {
    ...
    _colorHexController = TextEditingController(text: widget.tag['colorHex']);
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              Text('Edit Tag ${widget.tag['name']}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF520350), fontFamily: 'Inter')),
